...
public static class CompressionRatioGenerator
{
    ...
    public static ValueTask<double> CalculateCompressionRatioAsync(long fileSizeInBytes, long targetSize,
        long tolerance = 524288)
    {
        ...
        var compressionRatio = 1 / (1 / Math.Log2(adjustedTargetSize) * Math.Log2(fileSizeInBytes)) * multiplier;
